...
/-!
# Autoequivalences as a group after quotienting by natural isomorphism

`StabilityCondition/Symmetry/Autoequivalence/Slicing/Strict.lean` obtained a `MulAction` by restricting to autoequivalences
