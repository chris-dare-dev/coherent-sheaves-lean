...
structure QuadraticSupportData {t : TStructure C}
  ...
  quadratic : Support.HasQuadraticSupportProperty Zlin (W.semistableClasses v)
...
structure UniformQuadraticSupportData {t : TStructure C}
  ...
  quadratic : Support.HasUniformQuadraticSupportProperty Zlin
...
structure QuotientUniformQuadraticSupportData {t : TStructure C}
  ...
  semistable classes. -/
  quadratic : Support.HasUniformQuadraticSupportPropertyModulo V₀ Zlin hV₀
    (fun i => (W i).semistableClasses v)
...
theorem QuotientUniformQuadraticSupportData.fiber {t : TStructure C}
    ...
    Support.HasQuadraticSupportProperty
      (Support.quotientCharge V₀ Zlin hV₀)
...
theorem QuotientUniformQuadraticSupportData.zero_class_eq_zero {t : TStructure C}
    ...
    V₀.mkQ (v (K₀.of C E)) = 0 :=
  Support.mkQ_eq_zero_of_mem V₀ (h.zero_class_mem i E hE)
