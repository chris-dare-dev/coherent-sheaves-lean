...
`AlgebraicGeometry.OrderOfVanishing`; DerivedAlgGeo uses the v4.32.1 patch release.
...
No algebraic-cycle or order-of-vanishing implementation belongs in DerivedAlgGeo.
-/
