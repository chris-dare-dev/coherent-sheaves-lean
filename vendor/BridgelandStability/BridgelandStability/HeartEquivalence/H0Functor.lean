...
theorem HeartStabilityData.H0primeObjIsoTruncGE_hom_naturality
  ...
  ext
  change (h.t.truncLE 0).map ((h.t.truncGE 0).map ((h.t.truncGEπ 0).app X)) ≫
      (h.t.truncLE 0).map ((h.t.truncGE 0).map ((h.t.truncGE 0).map g)) =
    (h.t.truncLE 0).map ((h.t.truncGE 0).map g) ≫
      (h.t.truncLE 0).map ((h.t.truncGE 0).map ((h.t.truncGEπ 0).app Y))
