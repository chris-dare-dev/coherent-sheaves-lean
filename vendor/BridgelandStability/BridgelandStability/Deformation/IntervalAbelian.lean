...
theorem P_phi_of_truncation_of_P_phi_cone
  ...
  have hZtrunc : σ.charge X₃ =
    ...
    change cl C v X₃ = cl C v ((t.truncLT 0).obj X₃) +
      cl C v ((t.truncGE 0).obj X₃) at h
    change σ.Z (cl C v X₃) = σ.Z (cl C v ((t.truncLT 0).obj X₃)) +
      σ.Z (cl C v ((t.truncGE 0).obj X₃))
    rw [h, map_add]
...
@[reducible, nolint defsWithUnderscore]
