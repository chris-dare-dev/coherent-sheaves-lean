...
theorem interval_strictShortExact_cokernel_of_strictMono
  ...
  have hEpi : Epi ((S.map FL).g) := by
    ...
    exact Slicing.IntervalCat.epi_toLeftHeart_of_strictEpi
...
def intervalLiftSubCokernelIso
  ...
  have hArrow :
    ...
    simpa [fLift, fBase, intervalLiftSub, eA, eB, Category.assoc] using
