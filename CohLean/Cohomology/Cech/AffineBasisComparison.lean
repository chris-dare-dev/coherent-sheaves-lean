...
/-!
# Affine Cech-to-derived comparison on the distinguished-open basis

This file combines the relative distinguished-open calculation with the compact-basis
comparison theorem.  It also supplies the categorical bridge from a module-valued Cech
complex to the Cech complex of its underlying abelian-group-valued presheaf.
-/
...
/-- The Cech complex of an underlying additive-group-valued presheaf is canonically the
forgotten module-valued Cech complex. -/
...
/-- Exactness of a module-valued Cech complex passes to the Cech complex of the underlying
