...
and would add a large dependency for an API which is otherwise elementary.  Consequently CohLean
...
namespace CohLean.Intersection.NumericalPolynomial
...
end CohLean.Intersection.NumericalPolynomial
