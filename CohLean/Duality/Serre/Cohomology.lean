...
namespace CohLean.Duality.Serre
...
structure SurfacePicardSymmetry
    ...
    (I : CohLean.Intersection.Number.IntersectionContext D C 2)
...
variable {I : CohLean.Intersection.Number.IntersectionContext D C 2}
