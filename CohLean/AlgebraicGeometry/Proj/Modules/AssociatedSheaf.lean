...
-/
import CohLean.AlgebraicGeometry.Proj.Modules.GradedLocalization
...
`CohLean.AlgebraicGeometry.Proj.Modules.GradedLocalization`, and its sections are the dependent
...
@[simp]
theorem res_apply {U V : (Opens X)ᵒᵖ} (i : V ⟶ U)
