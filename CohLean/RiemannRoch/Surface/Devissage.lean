...
-/
import CohLean.RiemannRoch.Surface.ToddData
...
Mathlib/CohLean API has no theorem producing a finite locally free resolution for every coherent
...
namespace CohLean.RiemannRoch.Surface.Devissage
...
open CohLean.RiemannRoch.Surface.ToddData
...
end CohLean.RiemannRoch.Surface.Devissage
