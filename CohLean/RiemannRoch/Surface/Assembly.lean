...
-/
import CohLean.RiemannRoch.Surface.Devissage
...
namespace CohLean.RiemannRoch.Surface.Assembly
...
theorem sheaf_hirzebruch_riemannRoch
  ...
  have ht2 : CohLean.Intersection.ChernCharacter.toddComponent T.structureData 2 = t2 := rfl
...
end CohLean.RiemannRoch.Surface.Assembly
